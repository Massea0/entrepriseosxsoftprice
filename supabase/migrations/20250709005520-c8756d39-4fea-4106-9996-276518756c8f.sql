...
SELECT 
    ...
    '["Leadership", "Stratégie", "Management"]'::jsonb, 'active', now(), now()
...
SELECT 
    ...
    '["React", "Node.js", "TypeScript", "Leadership", "Architecture"]'::jsonb, 'active', now(), now()
FROM public.departments d, public.branches b 
...
SELECT 
    ...
    '["React", "Node.js", "PostgreSQL", "AWS"]'::jsonb, 'active', now(), now()
FROM public.departments d, public.branches b 
WHERE d.code = 'DEV' AND b.code = 'HQ-DKR'
UNION ALL
SELECT 
    ...
    '["React", "TypeScript", "CSS", "UI/UX"]'::jsonb, 'active', now(), now()
FROM public.departments d, public.branches b 
WHERE d.code = 'DEV' AND b.code = 'HQ-DKR'
UNION ALL
SELECT 
    ...
    '["RH", "Recrutement", "Paie", "Droit du travail"]'::jsonb, 'active', now(), now()
FROM public.departments d, public.branches b 
...
SELECT 
    ...
    '["Vente", "Négociation", "CRM", "Management"]'::jsonb, 'active', now(), now()
FROM public.departments d, public.branches b 
...
SELECT 
    ...
    '["Relation client", "CRM", "Communication"]'::jsonb, 'active', now(), now()
FROM public.departments d, public.branches b 
WHERE d.code = 'COM' AND b.code = 'HQ-DKR'
UNION ALL
SELECT 
    ...
    d.id, b.id, 3, 1800000, 2800000, 
    '["Comptabilité", "Finance", "Audit", "Fiscalité"]'::jsonb, 'active', now(), now()
FROM public.departments d, public.branches b 
WHERE d.code = 'FIN' AND b.code = 'HQ-DKR';

-- 4. Créer le directeur général d'abord
...
SELECT 
    'EMP-001', 'Massamba', 'Diouf', '05abd360-84e0-44a9-b708-1537ec50b6cc'::uuid,
    d.id, p.id, b.id, NULL,
    '2020-01-15'::date, '2020-01-15'::date, 6500000, 'active',
    'mdiouf@arcadis.tech', '+221 77 123 45 67', 
    '["Leadership", "Stratégie", "Innovation", "Management"]'::jsonb, 4.8, now(), now()
FROM public.departments d, public.positions p, public.branches b 
WHERE d.code = 'DG' AND p.code = 'DG-001' AND b.code = 'HQ-DKR';

-- 5. Créer les autres employés
INSERT INTO public.employees (
    employee_number, first_name, last_name, user_id, 
    department_id, position_id, branch_id, manager_id,
    hire_date, start_date, current_salary, employment_status,
...
SELECT 
    'EMP-002', 'Amadou', 'Ba', NULL::uuid,
    d.id, p.id, b.id, 
    (SELECT id FROM public.employees WHERE employee_number = 'EMP-001'),
    '2020-03-01'::date, '2020-03-01'::date, 3200000, 'active',
    'aba@arcadis.tech', '+221 77 234 56 78', 
    '["React", "Node.js", "TypeScript", "Leadership", "DevOps"]'::jsonb, 4.6, now(), now()
FROM public.departments d, public.positions p, public.branches b 
...
SELECT 
    'EMP-003', 'Fatou', 'Sow', NULL::uuid,
    d.id, p.id, b.id, 
    (SELECT id FROM public.employees WHERE employee_number = 'EMP-002'),
    '2021-01-15'::date, '2021-01-15'::date, 2300000, 'active',
    'fsow@arcadis.tech', '+221 77 345 67 89', 
    '["React", "Node.js", "PostgreSQL", "AWS", "Docker"]'::jsonb, 4.4, now(), now()
FROM public.departments d, public.positions p, public.branches b 
...
SELECT 
    'EMP-004', 'Ousmane', 'Diallo', NULL::uuid,
    d.id, p.id, b.id, 
    (SELECT id FROM public.employees WHERE employee_number = 'EMP-002'),
    '2021-06-01'::date, '2021-06-01'::date, 2100000, 'active',
    'odiallo@arcadis.tech', '+221 77 456 78 90', 
    '["React", "Node.js", "MongoDB", "GraphQL"]'::jsonb, 4.2, now(), now()
FROM public.departments d, public.positions p, public.branches b 
WHERE d.code = 'DEV' AND p.code = 'DEV-002' AND b.code = 'HQ-DKR'
...
SELECT 
    'EMP-005', 'Aissatou', 'Ndiaye', NULL::uuid,
    d.id, p.id, b.id, 
    (SELECT id FROM public.employees WHERE employee_number = 'EMP-002'),
    '2022-02-01'::date, '2022-02-01'::date, 1600000, 'active',
    'andiaye@arcadis.tech', '+221 77 567 89 01', 
    '["React", "TypeScript", "CSS", "Figma", "UI/UX"]'::jsonb, 4.3, now(), now()
FROM public.departments d, public.positions p, public.branches b 
...
SELECT 
    'EMP-006', 'Cheikh', 'Fall', NULL::uuid,
    d.id, p.id, b.id, 
    (SELECT id FROM public.employees WHERE employee_number = 'EMP-002'),
    '2022-09-15'::date, '2022-09-15'::date, 1400000, 'active',
    'cfall@arcadis.tech', '+221 77 678 90 12', 
    '["Vue.js", "JavaScript", "SASS", "Webpack"]'::jsonb, 4.0, now(), now()
FROM public.departments d, public.positions p, public.branches b 
WHERE d.code = 'DEV' AND p.code = 'DEV-003' AND b.code = 'HQ-DKR'
...
SELECT 
    'EMP-007', 'Mariama', 'Cisse', NULL::uuid,
    d.id, p.id, b.id, 
    (SELECT id FROM public.employees WHERE employee_number = 'EMP-001'),
    '2020-06-01'::date, '2020-06-01'::date, 2000000, 'active',
    'mcisse@arcadis.tech', '+221 77 789 01 23', 
    '["RH", "Recrutement", "Paie", "Formation", "Droit du travail"]'::jsonb, 4.5, now(), now()
FROM public.departments d, public.positions p, public.branches b 
...
SELECT 
    'EMP-008', 'Ibrahima', 'Sarr', NULL::uuid,
    d.id, p.id, b.id, 
    (SELECT id FROM public.employees WHERE employee_number = 'EMP-001'),
    '2020-08-15'::date, '2020-08-15'::date, 2800000, 'active',
    'isarr@arcadis.tech', '+221 77 890 12 34', 
    '["Vente", "Négociation", "CRM", "Management", "Business Development"]'::jsonb, 4.7, now(), now()
FROM public.departments d, public.positions p, public.branches b 
...
SELECT 
    'EMP-009', 'Coumba', 'Gueye', NULL::uuid,
    d.id, p.id, b.id, 
    (SELECT id FROM public.employees WHERE employee_number = 'EMP-008'),
    '2021-04-01'::date, '2021-04-01'::date, 1200000, 'active',
    'cgueye@arcadis.tech', '+221 77 901 23 45', 
    '["Relation client", "CRM", "Communication", "Suivi commercial"]'::jsonb, 4.1, now(), now()
FROM public.departments d, public.positions p, public.branches b 
...
SELECT 
    'EMP-010', 'Moussa', 'Kane', NULL::uuid,
    d.id, p.id, b.id, 
    (SELECT id FROM public.employees WHERE employee_number = 'EMP-008'),
    '2021-11-01'::date, '2021-11-01'::date, 1100000, 'active',
    'mkane@arcadis.tech', '+221 77 012 34 56', 
    '["Prospection", "Télémarketing", "CRM", "Lead Generation"]'::jsonb, 3.9, now(), now()
FROM public.departments d, public.positions p, public.branches b 
WHERE d.code = 'COM' AND p.code = 'COM-002' AND b.code = 'HQ-DKR'
...
SELECT 
    'EMP-011', 'Khadija', 'Diop', NULL::uuid,
    d.id, p.id, b.id, 
    (SELECT id FROM public.employees WHERE employee_number = 'EMP-001'),
    '2021-03-15'::date, '2021-03-15'::date, 2200000, 'active',
    'kdiop@arcadis.tech', '+221 77 123 45 89', 
    '["Comptabilité", "Finance", "Audit", "Fiscalité", "Contrôle de gestion"]'::jsonb, 4.4, now(), now()
FROM public.departments d, public.positions p, public.branches b 
