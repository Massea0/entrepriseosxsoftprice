...
export default function EmployeeDashboard() {
  ...
  const employeeMetrics = [
    {
      ...
      value: stats.assignments.activeTasks,
    ...
    {
      title: 'Performance',
      value: `${((stats.performance.completed / stats.performance.goals) * 100).toFixed(0)}%`,
      description: `${stats.performance.completed}/${stats.performance.goals} objectifs`,
      trend: 'up' as const,
      trendValue: stats.performance.rating,
      icon: Target
    },
    {
      title: 'Temps Travaillé',
      value: `${stats.timeTracking.thisWeek}h`,
      description: 'Cette semaine',
      trend: 'neutral' as const,
      trendValue: `${stats.timeTracking.overtime}h sup.`,
      icon: Clock
    },
    {
      title: 'Congés Restants',
      value: stats.leaveBalance.total,
      description: `${stats.leaveBalance.vacation} vacances + ${stats.leaveBalance.sick} maladie`,
      trend: 'neutral' as const,
      trendValue: 'Jours disponibles',
      icon: Calendar
    }
  ];
  ...
  const recentTasks = [
    {
      id: 1,
      title: "Finaliser rapport mensuel",
      project: "Gestion Financière",
      priority: "high",
      dueDate: "2025-01-18",
      progress: 85
    },
    ...
    {
      id: 4,
      title: "Révision code nouvelle feature",
      project: "Développement Tech",
      priority: "low",
      dueDate: "2025-01-22",
      progress: 20
  ...
  return (
    <div className="flex-1 relative min-h-screen overflow-hidden">
      ...
      />
      <MorphingBlob
        className="absolute top-1/4 right-1/4 w-96 h-96 opacity-30 z-0"
      />
      <MorphingBlob
        className="absolute bottom-1/4 left-1/4 w-80 h-80 opacity-20 z-0"
      />
      ...
      <div className="relative z-10 p-6 space-y-8">
        ...
        <HoverZone  className="text-center space-y-6">
          ...
          <GlowText className="text-xl text-gray-600 dark:text-gray-300 mt-4">
            Votre espace professionnel révolutionnaire ✨
          </GlowText>

          {/* Status Bar Révolutionnaire */}
          <div className="flex justify-center">
            <EnhancedCard className="bg-gradient-to-r from-purple-600 via-blue-600 to-green-600 text-white inline-block">
              <CardContent className="flex items-center gap-4 p-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium">Performance: {stats.performance.rating}</span>
                </div>
                <div className="flex items-center gap-2">
                  <Clock className="h-5 w-5" />
                  <span className="font-medium">{stats.timeTracking.thisWeek}h cette semaine</span>
                </div>
              </CardContent>
            </EnhancedCard>
          </div>
          ...
          <HoverZone>
            <EnhancedCard className="h-full">
              ...
              <CardContent className="space-y-4">
                <StaggeredList>
                  {recentTasks.map((task) => (
                    <StaggeredItem key={task.id}>
                      <MagneticButton className="w-full p-4 text-left bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 border hover:shadow-lg transition-all">
                ...
                <MagneticButton className="w-full mt-4 bg-gradient-to-r from-blue-500 to-blue-600 text-white">
          ...
          <EnhancedCard className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950 dark:to-emerald-950">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center">
                  <div className="mb-4">
                    <div className="text-3xl font-bold text-green-600">{stats.performance.completed}</div>
                    <div className="text-sm text-muted-foreground">Objectifs atteints</div>
                  </div>
                  <Progress value={(stats.performance.completed / stats.performance.goals) * 100} className="h-3" />
                </div>

                <div className="text-center">
                  <div className="mb-4">
                    <div className="text-3xl font-bold text-blue-600">{stats.performance.rating}</div>
                    <div className="text-sm text-muted-foreground">Évaluation actuelle</div>
                  </div>
                ...
                <div className="text-center">
                  <div className="mb-4">
                    <div className="text-3xl font-bold text-purple-600">
                      {new Date(stats.performance.nextReview).toLocaleDateString('fr-FR', { month: 'short', day: 'numeric' })}
                    </div>
                    <div className="text-sm text-muted-foreground">Prochaine évaluation</div>
                  </div>
                  <MagneticButton className="border border-input bg-background hover:bg-accent hover:text-accent-foreground px-3 py-1 text-sm">
          ...
          <EnhancedCard className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950 dark:to-purple-950">
            ...
            <CardContent>
              <StaggeredList className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <StaggeredItem>
                  <MagneticButton className="w-full h-20 bg-gradient-to-br from-orange-400 to-orange-600 text-white text-center">
                    <div>
